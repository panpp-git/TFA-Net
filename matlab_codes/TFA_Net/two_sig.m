...
d3 = 2 * pi * (-0.07);
d4 = 2 * pi * (-1);
Sig1 = 5*exp(1i*(c1 * t + c2 * t.^2  + c3 * t.^3 + c4 * sin(6*pi*t)));   % get the A(t)
Sig2 = 1*exp(1i*(d1 * t + d2 * t.^2  + d3 * t.^3 + d4 *sin(6*pi*t) ));   % get the A(t)
Sig=Sig1+Sig2;
Sig=awgn(Sig,10);
...
if1=(c1  + 2*c2 * t  + 3*c3 * t.^2 + c4 * cos(6*pi*t)*6*pi)/2/pi;
if2=(d1  + 2*d2 * t.^1  +3*d3 * t.^2 + d4 *cos(6*pi*t)*6*pi)/2/pi;
