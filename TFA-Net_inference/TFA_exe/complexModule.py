...
class FrequencyRepresentationModule_TFA_Net(nn.Module):
    def __init__(self, signal_dim=50, n_filters=8, n_layers=3, inner_dim=125,
        ...
        # self.dnoise1=ComplexConv1d2(1,n_filters,kernel_size=(1,5),padding=(0,5//2))
        # self.dnoise2 = ComplexConv1d(1, n_filters, kernel_size=(1, 7), padding=(0, 7// 2))
        # self.concat_layer=ComplexConv1d(2*n_filters,n_filters,kernel_size=(1,1))
        self.in_layer1 = ComplexConv1d(1, inner_dim * n_filters, kernel_size=(1, 31), padding=(0, 31 // 2),
                                       bias=False)
        # self.win = ComplexConv2d(n_filters, n_filters, kernel_size=(127, 1), padding=(127 // 2, 0),
        ...
        # self.out_layer2=nn.ReLU()
        # self.out_layer3=nn.Conv2d(n_filters//2, 1, (3, 3),padding=(1, 1))
    ...
    def forward(self, x):
        ...
        # x1=self.dnoise1(inp)
        # x1real,x1imag=torch.chunk(x1,2,1)
        # x2 = self.dnoise2(inp)
        # x2real, x2imag = torch.chunk(x2, 2, 1)
        # x=torch.cat((x1real,x2real,x1imag,x2imag),1)
