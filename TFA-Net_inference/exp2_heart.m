...
sp=1600;
ep=3000;
data_reshape=Y(sp:ep).';

FS=1/TS;
N=length(data_reshape);
time=N*TS;
t=sp*TS:TS:(ep+1)*TS-TS;
ydelta=FS/nfft;
...
%% GT
figure;plot(t,(data_reshape));
xlim([min(t) max(t)])
ylim([min(data_reshape) 2.5])
title('ECG time signal')
xlabel({'Time / sec';'(a)'})
ylabel('Amp.')
set(gca,'FontSize',fsz); 
set(get(gca,'XLabel'),'FontSize',fsz);
set(get(gca,'YLabel'),'FontSize',fsz);
rectangle('Position',[x11 -0.77 x22-x11 1.5],'EdgeColor','red','Linewidth',3);
% rectangle('Position',[x1 0.81 x2-x1 1.8-0.81],'EdgeColor','red','Linewidth',3);
...
plot(t,(data_reshape));
text(15.5,0.9,'R','Fontsize',13,'Color','r')
text(15.31,-0.35,'Q','Fontsize',13,'Color','r')
text(15.55,-0.705,'S','Fontsize',13,'Color','r')
text(15.2,-0.1,'P','Fontsize',13,'Color','r')
text(15.8,-0.2,'T','Fontsize',13,'Color','r')
set(gca,'xlim',[x11 x22],'ylim',[-0.77 1]);
fname=strcat('F:\pycharm_proj\cResTF\TFA_Net\figures_TFA_submit_20220120\figs\','exp2_heart_Ground_Truth');
saveas(gcf, fname);
...
fname=strcat('F:\pycharm_proj\cResTF\TFA_Net\figures_TFA_submit_20220120\figs\','exp2_heart_GWarblet');
saveas(gcf, fname);
...
set(gca,'ydir','normal')
set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
fname=strcat('F:\pycharm_proj\cResTF\TFA_Net\figures_TFA_submit_20220120\figs\','exp2_heart_SPWVD');
saveas(gcf, fname);
...
% set(gca,'ydir','normal')
% set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
% fname=strcat('F:\pycharm_proj\cResTF\TFA_Net\figures_TFA_submit_20220120\figs\','exp2_heart_CWT');
% saveas(gcf, fname);
%% STFT
...
set(gca,'ydir','normal')
set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
fname=strcat('F:\pycharm_proj\cResTF\TFA_Net\figures_TFA_submit_20220120\figs\','exp2_heart_STFT_win',num2str(winlen));
saveas(gcf, fname);
...
set(gca,'ydir','normal')
set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
fname=strcat('F:\pycharm_proj\cResTF\TFA_Net\figures_TFA_submit_20220120\figs\','exp2_heart_SST_win',num2str(winlen));
saveas(gcf, fname);
...
tt=t;
figure;
clims = [max(max(20*log10((abs(spc_SET)))))-90,max(max(20*log10((abs(spc_SET)))))];
...
set(gca,'ydir','normal')
set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
fname=strcat('F:\pycharm_proj\cResTF\TFA_Net\figures_TFA_submit_20220120\figs\','exp2_heart_SET_win',num2str(winlen));
saveas(gcf, fname);
...
tt=t;
figure;
clims = [max(max(20*log10((abs(spc_MSST)))))-90,max(max(20*log10((abs(spc_MSST)))))];
...
set(gca,'ydir','normal')
set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
fname=strcat('F:\pycharm_proj\cResTF\TFA_Net\figures_TFA_submit_20220120\figs\','exp2_heart_MSST_win',num2str(winlen));
saveas(gcf, fname);
...
set(gca,'ydir','normal')
set(gca,'xlim',[x11 x22],'ylim',[y11 y22]);
fname=strcat('F:\pycharm_proj\cResTF\TFA_Net\figures_TFA_submit_20220120\figs\','exp2_heart_TFA-Net');
saveas(gcf, fname);
